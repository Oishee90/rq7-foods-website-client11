...
import banner3 from "../../assets/penne-pasta-tomato-sauce-with-chicken-tomatoes-wooden-table (1).jpg"
    ...
    return (
        <div className='mb-5'>
            <div className='flex flex-col justify-center'>
                <h1 className='text-center  p-5 text-4xl font-oswald font-semiboldbold'> Food Gallery</h1>
      ...
      >
        <SwiperSlide>
            ...
            <h1 className=' text-white font-oswald font-bold text-2xl absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2'> Ramen Noodle</h1>
